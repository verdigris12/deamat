...
class MPLView():
    ...
    def _figure_settings_ui(self, fig):
        ...
        if changed:
            fig.suptitle(
                suptitle_text, fontsize=suptitle_fontsize, fontweight=suptitle_fontweight, verticalalignment=suptitle_va, horizontalalignment=suptitle_ha, x=suptitle_x, y=suptitle_y
            )
